import pytest
import numpy as np
from pyplasmaopt import  BiotSavart, get_24_coil_data, CoilCollection, QuasiSymmetricField, get_ncsx_data
...
def test_ft_surface():
    ...
    R, Z = qfm.position(params)
    Rbc, Zbs, _, _ = qfm.ft_surface(params,mmax,nmax)
    ...
    Rbc, Zbs, _, _ = qfm.ft_surface(params,mmax+1,nmax+1)
    ...
    Rbc, Zbs, _, _ = qfm.ft_surface(params,mmax,nmax-1)
